...
export function ImageCarousel({
    ...
    return (
        ...
        >
            {/* Image Display */}
            <div className="rounded-2xl overflow-hidden z-40 h-[50vh] flex items-center justify-center">
                <Image
                    isZoomed
            ...
            <Modal isOpen={selectedPhotoIndex !== null} size="full" radius="none" hideCloseButton={true}>
                <ModalContent>
                    {(_) => (
                        <ModalBody
                            className="p-0"
                        ...
                        >
                            <div className="relative w-full h-screen flex items-center justify-center">
                                ...
                                <Button
                                    ...
                                    color="default"
                                    variant="flat"
                                    className="absolute top-2 right-2 bg-white/20 backdrop-blur-lg z-50"
                                    size="md"
                                    onPress={closeModal}
                                >
